...
gui.addColor(parameters, "innerColor").onFinishChange(galaxyGenerator)
gui.addColor(parameters, "outerColor").onFinishChange(galaxyGenerator)
/** 
* Sizes
 */
const sizes = {
